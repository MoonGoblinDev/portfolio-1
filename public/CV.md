...
## SUMMARY
Product-minded engineer who designs and ships end-to-end experiences across Apple platforms and modern web/desktop. Apple Developer Academy @BINUS graduate and founder of Ainotra (cross-platform reading ecosystem). Strong in Swift/SwiftUI, React/TypeScript, offline-first data, cross-device connectivity, and rapid prototyping.
## SKILLS
...
### iOS Developer (Project-Based) | Apple Developer Academy @Bali | Bali, Indonesia
**03/2025 – 12/2025**
...
**07/2021 – 03/2025**
- Built and shipped games/tools in Unity with an emphasis on fun, responsive feel, performance, and clear UX for creators.
...
### MacDirect (macOS)
macOS distribution app + updater framework (Sparkle alternative).
- Automates build/sign/notarize + packaging (DMG/ZIP/PKG), generates an update feed (updates.json), and supports secure updates with Team ID verification and a helper app.

### Defau (macOS)
Default apps manager with monitoring and folder-based routing rules.
- Uses LaunchServices/UTType to manage default handlers, adds per-folder rules to route file opens, and logs external changes with safety warnings for critical associations.
